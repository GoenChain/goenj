...
public class ByteUtil {
	...
	/**
	 * The regular {@link BigInteger#toByteArray()} method isn't quite what we
	 * often need: it appends a leading zero to indicate that the number is
	...
	/**
	 * Cast hex encoded value from byte[] to BigInteger null is parsed like
	 * byte[0]
	 *
	 * @param bb
