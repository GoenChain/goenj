...
public class TestDHT {
    ...
    public void testDHT() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            distributedHashTable.insertNode(nodeA);
            distributedHashTable.insertNode(nodeB);
            distributedHashTable.insertNode(nodeC);
            distributedHashTable.insertNode(nodeD);
        }
        Assert.assertEquals(distributedHashTable.getAllNodes().size(), 4);
